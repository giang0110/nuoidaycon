...
export const vi = {
  ...
  history: {
    ...
    awaitingReview: 'Chờ bố mẹ xem',
    distribution: 'Phân bổ hoạt động',
    insights: 'Gợi ý cho bố mẹ',
    difficulty: 'Độ khó hiện tại',
    recent: 'Hoạt động gần đây',
    noWindowActivity: 'Chưa có hoạt động nào trong khoảng thời gian này.',
    progressLink: 'Xem tiến bộ & lịch sử',
    insightAwaitingReview: 'bài đang chờ bạn nhận xét.',
